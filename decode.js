...
self.addEventListener('message', function (e) {
    ...
    if (packer === 'evalencode') {
        ...
        try {
            self.importScripts('https://raw.githack.com/softwebtuts/softwebtuts.com/master/aadecode.js');
        ...
        try {
            self.importScripts('https://raw.githack.com/softwebtuts/softwebtuts.com/master/jjdecode.js');
        ...
        try {
            self.importScripts('https://raw.githack.com/softwebtuts/softwebtuts.com/master/urlencode_unpacker.js');
        ...
        try {
            self.importScripts('https://raw.githack.com/softwebtuts/softwebtuts.com/master/p_a_c_k_e_r_unpacker.js');
        ...
        try {
            self.importScripts('https://raw.githack.com/softwebtuts/softwebtuts.com/master/javascriptobfuscator_unpacker.js');
        ...
        try {
            self.importScripts('https://raw.githack.com/softwebtuts/softwebtuts.com/master/myobfuscate_unpacker.js');
